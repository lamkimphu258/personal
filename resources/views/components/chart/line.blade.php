...
>
    ...
    <div class="relative h-64 w-full">
        <div class="absolute inset-0 hidden items-center justify-center text-sm text-slate-400" data-line-chart-loading>
        ...
        <div class="absolute inset-0 hidden items-center justify-center px-6 text-center text-sm text-slate-400" data-line-chart-message></div>

        <canvas data-line-chart-canvas class="h-full w-full"></canvas>
    </div>
